...
var Config = struct {
	...
	OTPApiURLs: []string{
		...
		"https://kami-api1-production.up.railway.app/api/kk?type=sms",
		"https://kami-api1-production.up.railway.app/api/hs?type=sms",
		"https://kami-api1-production.up.railway.app/api/ivs?type=sms",
		"https://kami-api1-production.up.railway.app/api/vc?type=sms",
	},
